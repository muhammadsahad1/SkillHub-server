...
export interface IuserRepository {
     ...
     */
    createUser(newUser: any): Promise<any | void | {
        success: boolean;
        user?: any;
        token: {
            accessToken: string;
     ...
     */
    fetchProfileImage(s3upload: any, userId: string): Promise<FetchProfileImageResponse | undefined>;
    /**
     ...
     */
    editPost(caption: string, postId: string): Promise<{

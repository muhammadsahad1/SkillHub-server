...
export interface IuserUseCase {
    ...
    createUser(email: string, otp: string, next: Next): Promise<{
        success: boolean;
        user?: Iuser;
        tokens: {
            accessToken: string;
    ...
    uploadCoverImage(userId: string, file: Express.Multer.File | undefined, next: Next): Promise<Iuser | void>;
    ...
    removeFollower(fromRemoveId: string, toRemoveId: string, next: Next): Promise<{
        success: boolean;
        message: string;
    }>;
    uploadPost(userId: string, imageUrl: Express.Multer.File | undefined, caption: string, type: string): Promise<any>;
    uploadThoughts(userId: string, type: string, next: Next): Promise<{
        success: boolean;
        thoughtPost: Ipost;
    } | void>;
    ...
    postLike(userId: string, postId: string, next: Next): Promise<{
        message: string;
        postId: string;
    }>;

...
const joinGroup = (groupId, joinUserId, groupRepository, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const result = yield groupRepository.joinGroup(groupId, joinUserId);
        if (!result) {

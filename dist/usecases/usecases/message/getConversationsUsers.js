...
const getConversationsUsers = (userId, messageRepository, s3, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const result = yield messageRepository.getConversationsUsers(userId, s3);
        if (!result) {

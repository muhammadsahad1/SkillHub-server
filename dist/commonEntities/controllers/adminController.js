...
class AdminController {
  ...
  adminLogin(req, res, next) {
    return __awaiter(this, void 0, void 0, function* () {
      var _a, _b;
      const result = yield this.adminUseCase.adminLogin(
        req.body.email,
        req.body.password,
        next
      );
      ...
      res.cookie(
        "admin_access_token",
        (_a = result.tokens) === null || _a === void 0
          ? void 0
          : _a.accessToken,
        jwt_1.accessTokenOption
      );
      res.cookie(
        "admin_refresh_token",
        (_b = result.tokens) === null || _b === void 0
          ? void 0
          : _b.refreshToken,
        jwt_1.refreshTokenOption
      );
  ...
  changeVerifyStatus(req, res, next) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      const result = yield this.adminUseCase.changeVerifyStatus(
        reqId,
        status,
        next
      );
  ...
  changeEventStatus(req, res, next) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      const result = yield this.adminUseCase.changeEventStatus(
        requestId,
        action,
        next
      );
  ...
  logout(req, res, next) {
    return __awaiter(this, void 0, void 0, function* () {
      try {
        ...
        return next(
          new errorMiddleware_1.ErrorHandler(error.status, error.message)
        );
      }
    });
  }
  ...
  reportAction(req, res, next) {
    return __awaiter(this, void 0, void 0, function* () {
      try {
        ...
        const result = yield this.adminUseCase.reportAction(
          reportId,
          status,
          next
        );
